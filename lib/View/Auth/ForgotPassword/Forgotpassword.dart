...
class _ForgotpasswordState extends State<Forgotpassword> {
  ...
  Future<void> _resetPassword() async {
    ...
    if (_emailController.text.isEmpty) {
      Get.snackbar('Error', 'Enter your email to reset password', snackPosition: SnackPosition.BOTTOM);
      return;
    }
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    "Reset Password",
                    style: GoogleFonts.poppins(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.blue.shade700),
                  ),
                  ...
                  TextButton(
                    onPressed: () => Get.back(),
                    child: Text("Back to Login", style: GoogleFonts.poppins(fontSize: 14, color: Colors.blue.shade700)),
                  ),
                ],
              ),
            ),
